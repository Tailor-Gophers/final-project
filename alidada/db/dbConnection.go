...
func GetDbConnection() *gorm.DB {
	...
	err = db.AutoMigrate(&models.CancellationCondition{}, &models.User{}, &models.Flight{}, &models.FlightClass{}, &models.Passenger{}, &models.Token{}, &models.Order{}, &models.Reservation{})
	if err != nil {
		panic(err)
	}
